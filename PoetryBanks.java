/**
 * The Line Class contains objects of type Line. Each object contains the actual content of the String, the identity of
 * the rhyme (see 'Rhyme IDs' below), the number of syllables in the line, and an ID number for use in picking lines.
 * Each line's ID number is unique to the line's String.
 */
...
public class Line {
  ...
  public class Line extends Line {
    String content = "The sun helps me in only one way";
    int rhymeID = 1;
    int syllableCount = 9;
    int lineID = 1;
  }
  ...
  Line {
    String content = "He lets me see the next day";
    int rhymeID = 1;
    int syllableCount = 7;
    int lineID = 2;
  }
  ...
  Line{
    String content = "The page keeps my mind at bay";
    int rhymeID = 1;
    int syllableCount = 7;
    int lineID = 3;
  }
  ...
  Line {
    String content = "The pen is my friend who which I play";
    int rhymeID = 1;
    int syllableCount = 9;
    int lineID = 4;
  }
  ...
  Line {
    String content = "In every epic play";
    int rhymeID = 1;
    int syllableCount = 7;
    int lineID = 5;
  }
  ...
  Line {
    String content = "And those characters find a way";
    int rhymeID = 1;
    int syllableCount = 8;
    int lineID = 6;
  }
  ...
  Line {
    String content = "To remain in the play";
    int rhymeID = 1;
    int syllableCount = 5;
    int lineID = 7;
  }
  ...
  Line {
    String content = "The person who writes the play";
    int rhymeID = 1;
    int syllableCount = 7;
    int lineID = 8;
  }
  ...
  Line {
    String content = "You weren't even close to a first strike today";
    int rhymeID = 1;
    int syllableCount = 11;
    int lineID = 9;
  }

  Line {
    String content = "Things were just blown proportionally out of the way";
    int rhymeID = 1;
    int syllableCount = ;
    int lineID = 10;
  }
            Line{
    String content = "Why wasn't she able to get away?";
  int rhymeID = 1;
        int syllableCount = ;
        int lineID = ;

            Line{
    String content = "From her family's turmoil, she had to pay";
  int rhymeID = 1;
          int syllableCount = ;
          int lineID = ;

            Line{
    String content = "Across the skies, the stars, the milky way";
  int rhymeID = 1;
            int syllableCount = ;
            int lineID = ;

            Line{
    String content = "To the edges of the universe every day";
  int rhymeID = 1;
              int syllableCount = ;
              int lineID = ;

            Line{
    String content = "Her heart burns through all that gets in her way";
  int rhymeID = 1;
                int syllableCount = ;
                int lineID = ;
            ...
            Line{
    String content = "Her spirit was an apocalypse before this very day";
  }
  int rhymeID = 1;
            Line{
    String content = "And if you escape by any way";
  }
  int rhymeID = 1;
            Line{
    String content = "You still won't live to see another day";
  }
  int rhymeID = 1;
            Line{
    String content = "Why so far away?";
  }
  int rhymeID = 1;
            Line{
    String content = "I took the route I thought was the right way";
  }
  int rhymeID = 1;
            Line{
    String content = "But on that path, I managed to stray";
  }
  int rhymeID = 1;
            Line{
    String content = "Just know that it's better to keep away";
  }
  int rhymeID = 1;
            Line{
    String content = "Please promise me that you won't stay";
  }
  int rhymeID = 1;
            Line{
    String content = "Monday, Tuesday, Wednesday, Thursday, Friday";
  }
  int rhymeID = 1;
            Line{
    String content = "If I don't see you by Saturday";
  }
  int rhymeID = 1;
            Line{
    String content = "Of all the debris that falls away";
  }
  int rhymeID = 1;
            Line{
    String content = "For a while I'm sure they'll stay";
  }
  int rhymeID = 1;
            Line{
    String content = "To wash the bitter world away";
  }
  int rhymeID = 1;
            Line{
    String content = "And fill it completely in with clay";
  }
  int rhymeID = 1;
            Line{
    String content = "I'm just a paper tiger kept at bay";
  }
  int rhymeID = 1;
            Line{
    String content = "I've wandered out and lost my way";
  }
  int rhymeID = 1;
            Line{
    String content = "Pin my heart down to a tray";
  }
  int rhymeID = 1;
            Line{
    String content = "Cut it open, slice away";
  }
  int rhymeID = 1;
            Line{
    String content = "Find the purer parts that have gone astray";
  }
  int rhymeID = 1;
            Line{
    String content = "Remove the rot that changed my ways";
  }
  int rhymeID = 1;
            Line{
    String content = "I can't understand a single word you say";
  }
  int rhymeID = 1;
            Line{
    String content = "The tears that fall down your cheeks have chased your voice away";
  }
  int rhymeID = 1;
            Line{
    String content = "We create a million shades of gray";
  }
  int rhymeID = 1;
            Line{
    String content = "A different flavor for every day";
  }
  int rhymeID = 1;
            Line{
    String content = "I saved my money for a rainy day";
  }
  int rhymeID = 1;
            Line{
    String content = "But here every day the skies are gray";
  }

  int rhymeID = 1;
            Line{
    String content = "Even if I rot away";
  }
  int rhymeID = 1;
            Line{
    String content = "Never forget who I am today";
  }
  int rhymeID = 1;
    Line{
    String content = "I can't turn away";
  }
  int rhymeID = 1;


    Line {String content = "I'll roll my lips and pierce with my gaze";
                  int rhymeID = 1;
                  int syllableCount = ;
    int lineID = ;
    }
  ...
  Line {
    String content = "You'll fall into a sinner's haze";
    int rhymeID = 1;
    int syllableCount = ;
    int lineID = ;
  }
    ...
    // Add "-me" rhymes. If "-me" is selected, rhyme must be from eeRhyme.
    ...
    // "aim" and "ame" can also rhyme with "ain" "ane":
    String[] ameRhyme = {
    ...
    // "-ane", "-ain", can also be rhymed with "-aim" or "-ame":
    String[] aneRhyme = {
    ...
    // "-ide" as in "hide" or "formaldehyde":
    String[] ideRhyme = {
      "And stepped outside",
      "And almost cried",
    ...
    String[] ooRhyme = {
      ...
      "Every string of this fractured heart sings true",
    ...
    // "-oon" and "-oom" rhymes such as "bloom" or "ruin":
    String[] oonRhyme = {
    ...
    // "-ing" rhymes such as "going" or "snowing":
    String[] ingRhyme = {
    ...
    // "Or" or "ar" rhymes such as "war" or "floor":
    String[] orRhyme = {
      ...
      "Preceding her imprisionment behind those golden doors",
      "One, two, three, four",
    ...
    // "-en" and "-an" rhymes such as "again" or "when":
    String[] enRhyme = {
      "Could this be an omen?",
      "I'd happilly kill ten thousand men",
    ...
    // "-ded" and "-ed" such as "dead" or "ended":
    String[] edRhyme = [
    ...
    // "-er" rhymes such as "disaster" or "her":
    String[] erRhyme = {
    ...
    String[] outRhyme = {
      ...
      "All because I happilly wrote you out"
    ...
    // "Ord" as in "sword" or "word":
    String[] ordRhyme = {
      "Our pens meet but never our swords",
      "Over mindfulls of galloping words",
      "Twist her words",
    }
    ...
    // "-oy" or "oi" rhymes such as "destroy":
    String[] oyRhyme = {
    ...
    // "-ash" as in "rash" or "trash" (AKA me):
    String[] ashRhyme = {
    ...
    // "-eave" and "-eve" as in "leave" and all near rhymes:
    String[] eveRhyme = {
      "So leave",
    ...
    // "-ive" as in "ihv" such as "relative":
      String[] ivRhyme = {
      "It's all relative",
      }
    ...
    // "-un" rhymes such as "one" and "stun":
    String[] unRhyme = {
      ...
      "But when rainbow colors are over-done",
    ...
    // "-elt" and "-ealt" as in "felt" or "dealt":
    String[] eltRhyme = {
    ...
    // "-art" rhymes as in "heart" or "apart":
    String [] artRhyme = {
    ...
    // "-act" rhymes as in "abstract" or "fact":
    String[] actRhyme = {
    ...
    // "-is" and "-ish" rhymes such as "this" and "wish":
      String[] isRhyme = {
    ...
    // "-irl" and "orl" rhymes such as "girl" and "world":
      String[] urlRhyme = {
      ...
      // "-eep" and "eap" as in "sleep" or "reap":
      String[] eepRhyme = {
      ...
      // "-age" as in "ahhhge" such as "language" also "edge":
      String[] geRhyme = {
        "I didn't realize you spoke another language",
      }


      //"-age" as in "aaayyyge" such as "page":
      String[] aygeRhyme = {
      ...
      String[] eetRhyme = {
        "And she's off running quick as lightening on her feet",
      ...
      String[] ebRhyme = {
        "I'll weave your heart like I woved my web"
      }


      // It's amazing how much I wrote about "lust" as a teenager despite not experiencing intimacy.
      String[] ustRhyme = {
      ...
      // "-urst" and "-irst" as in "worst" or "first":
      String[] urstRhyme = {
      ...
      // "-oast" or "-ost" as in "boast" or "most":
      String[] oastRhyme = {
